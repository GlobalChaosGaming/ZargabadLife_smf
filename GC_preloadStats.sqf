private ["_i","_pair","_writepairs","_storage","_read","_output","_oldslot","_newkeys","_keys","_inv","_lic","_bldg","_weps","_mags","_q_output","_w_output","_foreachindex","_s_output","_item","_itemType","_availkey","_pendkey","_ap_output","_items","_queue","_workerskey","_fid","_facname","_facs","_player","_owner","_name","_uid","_tls","_slot","_epoch","_donator"];
...
_donator = [_name, "donatorcashbonus"] call ServerGetVar;
